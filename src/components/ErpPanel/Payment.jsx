    ...
    <>
      ...
      <Row gutter={[12, 12]}>
        ...
        >
          ...
          <Descriptions title={`Client : ${currentErp.strClientName}`} column={1}>
            <Descriptions.Item label="E-mail">{currentErp.strPaymentReceivedUser}</Descriptions.Item>
            <Descriptions.Item label="Phone">{currentErp.paymentStatus}</Descriptions.Item>
            <Divider dashed />
