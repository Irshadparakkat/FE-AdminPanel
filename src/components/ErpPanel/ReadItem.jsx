...
export default function ReadItem({ config }) {
  ...
  const [currentErp, setCurrentErp] = useState({
    strProject: '',
    strClientName: '',
      strReceivedAccountName: '',
      strPaymentReceivedUser: '',
      strRemarks: '',
      strPaymentMode: '',
  ...
  return (
    <>
      ...
      >
        <Row>
          <Statistic title="Status" value={currentErp.paymentStatus} />
          <Statistic
            title="SubTotal"
      ...
      <Divider dashed />
      <Descriptions title={`Client : ${currentErp.strProject}`}>
        <Descriptions.Item label="Address">{currentErp.strPaymentReceivedUser}</Descriptions.Item>
        <Descriptions.Item label="E-mail">{currentErp.paymentStatus}</Descriptions.Item>
        <Descriptions.Item label="Phone">{currentErp.strRemarks}</Descriptions.Item>
      </Descriptions>
      <Divider />
      <Row gutter={[12, 0]}>
        <Col className="gutter-row" span={11}>
